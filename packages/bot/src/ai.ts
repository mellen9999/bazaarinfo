...
const KNOWLEDGE: [RegExp, string][] = [
  [/kripp|kripparrian|rania/i, "Kripp (Octavian Morosan): Romanian-Canadian, born 1987. World-first HC Inferno Diablo 3 (June 19 2012, Barbarian w/ Krippi on Wizard, hours before nerf patch — only people to ever beat un-nerfed HC Inferno, Guinness record). PoE1 Season 1 race champion, GGG credited him in end credits for popularizing the game. THE Hearthstone Arena king for years, 2-vids/day schedule, #1 most influential HS player ever per esports.gg. Battlegrounds #1 most-watched streamer. Now plays The Bazaar. Wife=Rania (underflowR), married Oct 2014, she manages channel+edits. Vegan, drinks OJ, 920K YT subs 1.1B views. TSM member. Dropped out of physics/math for gaming. Methodical min-maxer."],
  ...
  [/kripp.*(hearth|hs|arena|battle.?ground|bg)|hearth.*(kripp)|arena.*(kripp)/i, "Kripp HS: got beta key 2013, became 2nd most popular HS streamer ever. Arena GOD — #1 NA leaderboard Jan 2017 + Sept 2018. 2013 BlizzCon Innkeeper's Invitational finalist (lost 2-3 to Artosis, decisive moment was losing to a Leper Gnome). Won 'Favorite HS Stream' + 'Most Engaged Viewers' 2013+2014. Disenchanted 660K dust worth of dupes live, crashed Blizzard servers. Casted HS World Championship BlizzCon 2015. Co-organized Challengestone tournament with Rania. Transitioned to Battlegrounds 2019, became #1 most-watched BG streamer. Voted #1 most influential HS player of all time. SeatStory Cup 2 (2015): rematch vs Artosis using their original 2013 BlizzCon decks — primitive aggro Paladin and old-school Warrior, hilariously outdated by 2015 standards. SeatStory Cup = TaKeTV's invitational in Krefeld Germany, couch format where players could sit with casters and commentate their own games."],
  [/kripp.*(meme|never.?lucky|oj|juice|vegan|salt|casual|copypasta|kripperino|lore)/i, "Kripp memes: 'Never Lucky' = his signature catchphrase, complains about RNG constantly while still dominating. OJ meme = drinks orange juice + grape juice on stream, said he'd spend donations on 'discounted OJ and falafel'. Went vegan, community joke that scientists studying bad luck isolated the variable: veganism. 'Kripperino Skipperino' = YT comment culture spawned endless -erino suffix memes. @casualkripp on IG — 'casual' became his light insult for bad plays. Known for visible salt/rage moments. WoW: first person to complete WoW Ironman Challenge (1-85, no deaths, white gear only, no talents, Troll Hunter)."],
