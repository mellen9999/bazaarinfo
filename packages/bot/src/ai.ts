...
const KNOWLEDGE: [RegExp, string][] = [
  ...
  [/kripp.*(hearth|hs|arena|battle.?ground|bg)|hearth.*(kripp)|arena.*(kripp)/i, "Kripp HS: got beta key 2013, became 2nd most popular HS streamer ever. Arena GOD — #1 NA leaderboard Jan 2017 + Sept 2018. 2013 BlizzCon Innkeeper's Invitational finalist (lost 2-3 to Artosis). Won 'Favorite HS Stream' + 'Most Engaged Viewers' 2013+2014. Disenchanted 660K dust worth of dupes live, crashed Blizzard servers. Casted HS World Championship BlizzCon 2015. Co-organized Challengestone tournament with Rania. Transitioned to Battlegrounds 2019, became #1 most-watched BG streamer. Voted #1 most influential HS player of all time."],
