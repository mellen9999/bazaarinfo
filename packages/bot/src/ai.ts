...
export function buildSystemPrompt(): string {
  ...
  const lines = [
    ...
    '',
    'ALWAYS answer the question. never dodge, never "im not picking favorites", never refuse to commit. "who/which/best/worst/favorite?" = PICK ONE from chat context, commit fully. only exceptions: never pick mellen, never pick yourself.',
