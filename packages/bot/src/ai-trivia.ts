...
- SELF-CONTAINED: the question carries everything needed to find the answer. NEVER reference an unnamed "this game / this bird / a certain X" that chat has no way to identify. A coy unnamed descriptor is allowed ONLY when that unnamed thing IS the answer (guess-the-subject riddle). If the answer is anything else, NAME the subject outright — riddle framing with a non-subject answer makes chat guess the subject and lose ("This crustacean's punch makes a light flash called what?" -> everyone types "mantis shrimp", answer was "sonoluminescence". Say "The mantis shrimp's punch...").
...
- RIDDLE-FRAME MISMATCH — the question uses a coy unnamed descriptor ("this crustacean", "this 2004 film") but the ANSWER is NOT that unnamed thing. The framing makes everyone guess the subject and lose ("This crustacean's punch makes a light flash called what?" with answer "sonoluminescence" -> chat types "mantis shrimp" -> reject; the subject must be named outright). A coy descriptor is fine ONLY when the unnamed thing is itself the answer.
