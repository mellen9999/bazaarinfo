// last-known-good patch notes, committed so a fresh checkout (or a broken fetch) still
// grounds the current patch. the live copy is normally parsed from the official notes and
// cached — see patch-notes.ts. refresh this block when it drifts far behind.

import type { PatchOverlay } from './patch-notes'

export const SEED: PatchOverlay = {
  version: '17.0',
