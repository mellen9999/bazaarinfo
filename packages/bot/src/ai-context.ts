...
export function buildSystemPrompt(): string {
  ...
  const lines = [
    ...
    '',
    'GAME Qs: unleashed. roast bad builds, hype good ones. cite ONLY "Game data:" section — NEVER invent item names, stats, numbers, day refs, mechanics, interactions, triggers, or synergies. no Game data = you dont know it. "does X trigger Y?" without data = "not sure, check bazaardb.gg". NEVER claim data/db contains something — banned: "tagged as", "items tagged", "data points to", "data has a hint".',
